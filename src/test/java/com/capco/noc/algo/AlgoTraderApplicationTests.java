...
public class AlgoTraderApplicationTests {
	...
	public void initTestData(){
		algoTradeService.setStockPriceMap(new LinkedHashMap<String, List<Tick>>(){{
			put("2018-01-02", new ArrayList<Tick>(){{
				add(new Tick(Ticker.A, A_INITIAL_PRICE));
				add(new Tick(Ticker.D, D_INITIAL_PRICE));
				add(new Tick(Ticker.B, B_INITIAL_PRICE));
				add(new Tick(Ticker.C, C_INITIAL_PRICE));
			}});

			put("2018-01-03", new ArrayList<Tick>(){{
				add(new Tick(Ticker.A, A_SECOND_PRICE));
				add(new Tick(Ticker.D, D_SECOND_PRICE));
				add(new Tick(Ticker.B, B_SECOND_PRICE));
				add(new Tick(Ticker.C, C_SECOND_PRICE));
			}});

			put("2018-01-04", new ArrayList<Tick>(){{
				add(new Tick(Ticker.A, A_THIRD_PRICE));
				add(new Tick(Ticker.D, D_THIRD_PRICE));
				add(new Tick(Ticker.B, B_THIRD_PRICE));
				add(new Tick(Ticker.C, C_THIRD_PRICE));
			}});
		}});
	}
	...
	public void test_stopLoss_001_staticEntirePositionSellTriggered() {
		...
		StrategyUnitStopLoss strategyUnit = new StrategyUnitStopLoss(Ticker.A);
	...
	public void test_takeProfit_001_staticEntirePositionSellTriggered() {
		...
		StrategyUnitTakeProfit strategyUnit = new StrategyUnitTakeProfit(Ticker.D);
	...
	public void test_buy_001_staticEntireCashBalanceBuyTriggered() {
		...
		StrategyUnitBuy strategyUnit = new StrategyUnitBuy(Ticker.A);
	...
	public void test_buy_011_updateStopLossPercentAfterBuy() {
		...
		StrategyUnitBuy strategyUnitBuy = new StrategyUnitBuy(Ticker.A);
		...
		StrategyUnitStopLoss strategyUnitStopLoss = new StrategyUnitStopLoss(Ticker.A);
	...
	public void test_buy_014_updateTakeProfitPercentAfterBuy() {
		...
		StrategyUnitTakeProfit strategyUnitTakeProfit = new StrategyUnitTakeProfit(Ticker.A);
